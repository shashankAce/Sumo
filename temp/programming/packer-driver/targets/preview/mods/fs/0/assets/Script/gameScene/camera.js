System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, Vec3, Vec2, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, Camera;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5908aO0WHdHiY5Xsmq1kJZI", "camera", undefined);
      ...
      _export("Camera", Camera = (_dec = ccclass('Camera'), _dec2 = property({
        type: Node
        ...
        _proto.update = function update(deltaTime) {
          var target_position = new Vec2(this.player.getPosition().x, this.player.getPosition().z);
